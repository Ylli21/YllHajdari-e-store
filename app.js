...
var products = {
    Atletet: {
        chicago: new Products("Atletet", "Nike Air Jordan 1 Chicago", 1200, "Red/Black", "Yes", "40/41/42"),
        blue: new Products("Atletet", "Nike Air Jordan 1 UNC", 800, "Light-Blue", "Yes", "38/39/40"),
        green: new Products("Atletet", "Nike Air Jordan 1 PINE GREEN", 1900, "Green/White", "Yes", "41/42"),
        purple: new Products("Atletet", "Nike Air Jordan 1 CourtPurple", 1300, "Purple", "No", "42"),
        black: new Products("Atletet", "Nike Air Jordan 1 Wolf Grey", 700, "Black", "Yes", "43/44"),
        orange: new Products("Atletet", "Nike Air Jordan 1 YinYang", 2400, "Orange/White", "No", "40"),
    },
    Rrobat: {
        rr1: new Products("Rrobat", "Nike Popover Hoody White & Black", 2100, "Black/White", "Yes", "32-26"),
        rr2: new Products("Rrobat", "MinusTwo Cargo Green&Yellow Pants", 1000, "Green/Yellow", "No", "30-36"),
        rr3: new Products("Rrobat", "MinusTwo Cargo Black&Purple Pants", 650, "Black/Purple", "Yes", "30-36"),
        rr4: new Products("Rrobat", "MinusTwo Black&Purple Hat", 300, "Black/Purple", "No", "29-31"),
        rr5: new Products("Rrobat", "Trapstar Jacket", 1650, "Light-Blue", "Yes", "29-37"),
        rr6: new Products("Rrobat", "Anime Hoodie Sakura Edition", 1900, "White/Black", "Yes", "28-33"),
    },
    Orat: {
        o1: new Products("Orat", "Rolex Gold Model", 1400, "Gold/Green", "Yes", "28"),
        o2: new Products("Orat", "Rolex Black Model", 750, "Black/White", "No", "23"),
        o3: new Products("Orat", "Daniel Wellington CAB", 2180, "Blue/Red/Black", "Yes", "26"),
        o4: new Products("Orat", "Hublot CaseProtector", 3800, "Gold/Black", "Yes", "32"),
        o5: new Products("Orat", "Casio Protrek G-SHOCK", 3300, "Black", "Yes", "30"),
        o6: new Products("Orat", "Emporio Armani", 2730, "Brown/Black", "No", "24")
    },
}
function filter() {
